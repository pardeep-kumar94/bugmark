  ...
  return (
    <section className="px-3 pb-3 sm:px-5 sm:pb-5">
      <div className="relative isolate mx-auto max-w-7xl overflow-hidden rounded-[24px] border border-line bg-surface px-6 py-20 text-center sm:py-28">
        ...
        <LogoMark size={56} className="mx-auto drop-shadow-[0_12px_30px_rgba(74,222,128,.45)]" />
        <h2 className="mx-auto mt-8 max-w-3xl font-mono text-[32px] font-semibold leading-[1.08] tracking-[-0.055em] text-balance sm:text-[54px]">
          Stop describing bugs. <span className="text-brand">Send the evidence.</span>
        </h2>
        ...
        <div className="mx-auto mt-10 inline-flex items-center gap-2 rounded-lg border border-line bg-canvas px-3.5 py-2 font-mono text-[12.5px] text-dim">
